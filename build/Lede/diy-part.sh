...
export Op_name="OpenWrt-123515"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
# 更换固件内核
export Replace_Kernel="6.2"                    # 更换内核版本,在对应源码的[target/linux/架构]查看patches-x.x,看看x.x有啥就有啥内核了(填入内核版本号,填0为不作修改)
